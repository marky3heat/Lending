...
$(function () {
    ...
    $(".stepy-validation").stepy({
        ...
        next: function (index) {
            ...
            if (index === 2) {
                setTimeout(function () {
                    app.vm.loadAccountList($("#customerId").val());
                }, 300);

                app.vm.forSaveingModel.CustomerId = $("#customerId").val();
                app.vm.forSaveingModel.CustomerName = $("#customerId").find('option:selected').text();
            }
            if (index === 3) {
